...
class Transaction(models.Model):
    ...
    payment_amount = models.DecimalField(default=0, decimal_places=2, max_digits=20, verbose_name='Баланс счёта')
    time = models.DateTimeField(auto_now=True, verbose_name='Время транзакции')
